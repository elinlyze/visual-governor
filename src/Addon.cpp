...
// Visual Governor is deliberately split into public governor/UI code and a private
// native GW2 bridge. The bridge is included here as implementation detail so the
// build stays simple, but it is isolated under src/private/ for review/publication.
...
extern "C" __declspec(dllexport) AddonDefinition_t* GetAddonDef()
{
    static AddonDefinition_t def{
        ...
        { 0, 69, 0, 0 },
        "local build",
        "Automatic visual settings governor with tiered graphics profiles, startup-safe renderer gating, and optional mini tier overlay.",
        AddonLoad,
        AddonUnload,
        AF_None,
        UP_None,
